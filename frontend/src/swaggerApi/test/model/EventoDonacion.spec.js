...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiDocumentada.EventoDonacion();
  });
  ...
  describe('EventoDonacion', function() {
    it('should create an instance of EventoDonacion', function() {
      // uncomment below and update the code to test EventoDonacion
