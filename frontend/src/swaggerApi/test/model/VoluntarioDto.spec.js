...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiDocumentada.VoluntarioDto();
  });
  ...
  describe('VoluntarioDto', function() {
    it('should create an instance of VoluntarioDto', function() {
      // uncomment below and update the code to test VoluntarioDto
      //var instance = new ApiDocumentada.VoluntarioDto();
      //expect(instance).to.be.a(ApiDocumentada.VoluntarioDto);
    });
