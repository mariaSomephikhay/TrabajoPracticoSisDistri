...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiDocumentada.SolicitudBaja();
  });
  ...
  describe('SolicitudBaja', function() {
    it('should create an instance of SolicitudBaja', function() {
      // uncomment below and update the code to test SolicitudBaja
      //var instance = new ApiDocumentada.SolicitudBaja();
      //expect(instance).to.be.a(ApiDocumentada.SolicitudBaja);
    });
