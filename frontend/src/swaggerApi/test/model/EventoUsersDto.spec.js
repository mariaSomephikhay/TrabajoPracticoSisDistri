...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiDocumentada.EventoUsersDto();
  });
  ...
  describe('EventoUsersDto', function() {
    it('should create an instance of EventoUsersDto', function() {
      // uncomment below and update the code to test EventoUsersDto
