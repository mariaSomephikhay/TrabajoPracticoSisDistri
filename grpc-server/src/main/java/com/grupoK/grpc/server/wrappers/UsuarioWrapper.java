...
public class UsuarioWrapper {
    ...
    public com.grupoK.grpc.proto.Usuario toGrpcUsuario(Usuario userModel) {
        return com.grupoK.grpc.proto.Usuario.newBuilder()
    ...
    public Usuario toEntityUsuario(com.grupoK.grpc.proto.Usuario userModel) {
