...
class ManagerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.getAllDonaciones = channel.unary_unary(
                ...
                _registered_method=True)
        self.getAllDonacionesWithoutOffersByOrganization = channel.unary_unary(
                '/managerservice.ManagerService/getAllDonacionesWithoutOffersByOrganization',
        ...
        self.getAllOffersByOrganization = channel.unary_unary(
                ...
                _registered_method=True)
        self.getLastOffer = channel.unary_unary(
                '/managerservice.ManagerService/getLastOffer',
                request_serializer=donaciones__eventos__pb2.Empty.SerializeToString,
                response_deserializer=donaciones__eventos__pb2.Oferta.FromString,
                _registered_method=True)
...
class ManagerServiceServicer(object):
    ...
    def getAllDonacionesWithoutOffersByOrganization(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
    ...
    def getLastOffer(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_ManagerServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'getAllDonacionesWithoutOffersByOrganization': grpc.unary_unary_rpc_method_handler(
                    servicer.getAllDonacionesWithoutOffersByOrganization,
            ...
            'getLastOffer': grpc.unary_unary_rpc_method_handler(
                    servicer.getLastOffer,
                    request_deserializer=donaciones__eventos__pb2.Empty.FromString,
                    response_serializer=donaciones__eventos__pb2.Oferta.SerializeToString,
            ),
    }
...
class ManagerService(object):
    ...
    @staticmethod
    def getAllDonacionesWithoutOffersByOrganization(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    def getLastOffer(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/managerservice.ManagerService/getLastOffer',
            donaciones__eventos__pb2.Empty.SerializeToString,
            donaciones__eventos__pb2.Oferta.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
